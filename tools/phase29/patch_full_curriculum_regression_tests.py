...
patch(
    ...
    [
        ...
        (
            ...
            '''        var stageOneIds = stageOne.Select(x => x.Id).ToArray();\n        var supportingIds = supportingPrimary.Concat(supportingLater).Select(x => x.Id).ToArray();\n\n        Assert.NotEmpty(supportingLater.Where(x => x.LogicalLevelFrom == 7));\n        Assert.NotEmpty(supportingLater.Where(x => x.LogicalLevelFrom == 8));\n        Assert.NotEmpty(supportingLater.Where(x => x.LogicalLevelFrom == 9));\n        Assert.NotEmpty(supportingLater.Where(x => x.LogicalLevelFrom == 10 && x.Pathway == "Core"));\n        Assert.NotEmpty(supportingLater.Where(x => x.LogicalLevelFrom == 10 && x.Pathway == "Extended"));\n        Assert.NotEmpty(supportingLater.Where(x => x.LogicalLevelFrom == 11 && x.Pathway == "Core"));\n        Assert.NotEmpty(supportingLater.Where(x => x.LogicalLevelFrom == 11 && x.Pathway == "Extended"));\n        Assert.NotEmpty(supportingLater.Where(x => x.LogicalLevelFrom == 12 && x.Pathway == "Component/route structure preserved in reference graph"));\n        Assert.NotEmpty(supportingLater.Where(x => x.LogicalLevelFrom == 13 && x.Pathway == "Component/route structure preserved in reference graph"));\n''',
        ),
        (
