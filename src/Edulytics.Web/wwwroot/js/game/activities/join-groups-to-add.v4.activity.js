(function (global) {
    ...
    global.EdulyticsGameActivities['join-groups-to-add-v4'] = {
        ...
        world: {
            name: 'Lantern Isles',
            mapNodes: [
                { id: 1, name: 'Meadow Gate', x: 0.18, y: 0.58 },
                { id: 2, name: 'Glow Falls', x: 0.33, y: 0.34 },
                { id: 3, name: 'Firefly Bend', x: 0.47, y: 0.56 },
                { id: 4, name: 'Moonlit Ford', x: 0.60, y: 0.30 },
                { id: 5, name: 'Lantern Grove', x: 0.72, y: 0.54 },
                { id: 6, name: 'River Steps', x: 0.83, y: 0.29 },
                { id: 7, name: 'Star Meadow', x: 0.68, y: 0.76 },
                { id: 8, name: 'Whisper Bridge', x: 0.50, y: 0.78 },
                { id: 9, name: 'Sunset Hollow', x: 0.31, y: 0.78 },
                { id: 10, name: 'Beacon Hill', x: 0.13, y: 0.80 }
            ]
        },
        copy: {
            ...
            introDialogue: [
                { speaker: 'guide', text: n => `Welcome, ${n}. Lantern Isles is waking up, but the light paths are broken.` },
                { speaker: 'student', text: () => 'Can we bring the lights back?' },
                { speaker: 'guide', text: () => 'Yes. Join each pair of firefly groups, light the lantern, then choose the stepping stone with the total.' }
            ],
