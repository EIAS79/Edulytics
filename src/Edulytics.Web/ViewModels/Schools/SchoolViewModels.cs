...
{
    public IReadOnlyList<SchoolListRowViewModel> Schools { get; init; } = Array.Empty<SchoolListRowViewModel>();
}
...
public sealed class SchoolListRowViewModel
{
    ...
    public static SchoolListRowViewModel FromService(SchoolListItem school) => new()
    {
        Id = school.Id,
        Name = school.Name,
...
public sealed class SchoolDetailsViewModel
{
    ...
    public DateTime? TrialStartsAtUtc { get; init; }
    public DateTime? TrialEndsAtUtc { get; init; }
    public bool TrialIsCurrentlyUsable { get; init; }

    public static SchoolDetailsViewModel FromService(SchoolDetails school) => new()
    {
        Id = school.Id,
        Name = school.Name,
        SchoolCode = school.SchoolCode,
        ...
        CanReactivate = school.CanReactivate,
        CanArchive = school.CanArchive,
        CanStartTrial = school.CanStartTrial,
        TrialStartsAtUtc = school.TrialStartsAtUtc,
        TrialEndsAtUtc = school.TrialEndsAtUtc,
        TrialIsCurrentlyUsable = school.TrialIsCurrentlyUsable
    };
}
