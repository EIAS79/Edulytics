...
namespace Edulytics.Data.Migrations
{
    ...
    [Migration("20260904102852_Phase42PrivateStudentPractice")]
    partial class Phase42PrivateStudentPractice
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.Assessment", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "TargetStudentProfileId");
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.AssessmentItem", b =>
                {
                    ...
                    b.Property<string>("GenerationFamily")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
                    ...
                    b.HasIndex("SchoolId", "ExposureFingerprint");

                    b.HasIndex("SchoolId", "CurriculumAdoptionId", "CurriculumPedagogicalLessonId");

                    b.ToTable("AssessmentItems", (string)null);
                });

            modelBuilder.Entity("Edulytics.Core.Entities.AssessmentItemOutcome", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SchoolId", "AssessmentItemId", "LearningOutcomeId")
                        .IsUnique();

                    b.ToTable("AssessmentItemOutcomes", (string)null);
                });
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.ClassGroup", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "AcademicYearId", "CurriculumAdoptionId", "NormalizedName")
                        .IsUnique()
                        .HasDatabaseName("UX_ClassGroup_CurriculumAdoption_Name")
                        .HasFilter("\"CurriculumAdoptionId\" IS NOT NULL AND \"NormalizedName\" IS NOT NULL");
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.CurriculumTopic", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "CurriculumAdoptionId", "Name")
                        .IsUnique()
                        .HasDatabaseName("UX_CurriculumTopic_Adoption_Name")
                        .HasFilter("\"CurriculumAdoptionId\" IS NOT NULL");

                    b.HasIndex("SchoolId", "CurriculumAdoptionId", "Order")
                        .IsUnique()
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.LearningEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SchoolId", "PracticeAttemptId", "AssessmentItemId", "LearningOutcomeId")
                        .IsUnique();

                    b.HasIndex("SchoolId", "StudentProfileId", "LearningOutcomeId", "OccurredAtUtc");
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.LearningOutcome", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "CurriculumAdoptionId", "Code")
                        .IsUnique()
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.PracticeAttempt", b =>
                {
                    ...
                    b.HasIndex("SchoolId", "IsPrivate", "StudentProfileId", "SubmittedAtUtc");

                    b.ToTable("PracticeAttempts", (string)null);
                });

            modelBuilder.Entity("Edulytics.Core.Entities.PracticeAttemptItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SchoolId", "PracticeAttemptId", "AssessmentItemId")
                        .IsUnique();

                    b.HasIndex("SchoolId", "PracticeAttemptId", "Order")
                        .IsUnique();

                    b.ToTable("PracticeAttemptItems", (string)null);
                });

            modelBuilder.Entity("Edulytics.Core.Entities.PracticeResponse", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("PracticeAttemptItemId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SchoolId", "PracticeAttemptItemId")
                        .IsUnique();

                    b.ToTable("PracticeResponses", (string)null);
                });
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.SchoolCurriculumAdoption", b =>
                {
                    ...
                    b.Property<string>("CurriculumStage")
                        .HasMaxLength(160)
                        .HasColumnType("character varying(160)");
                    ...
                    b.HasIndex("SchoolId", "AcademicYearId", "AcademicProgramId", "CurriculumLevelKey", "SubjectId")
                        .IsUnique()
                        .HasDatabaseName("UX_CurriculumAdoption_PrimaryExplicitLevel")
                        .HasFilter("\"IsPrimary\" = TRUE AND \"CurriculumLevelKey\" IS NOT NULL");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("SchoolId", "AcademicYearId", "AcademicProgramId", "CurriculumLevelKey", "SubjectId"), false);
                    ...
                    b.HasIndex("SchoolId", "AcademicYearId", "AcademicProgramId", "CurriculumLevelKey", "SubjectId", "FrameworkVersionId")
                        .IsUnique()
                        .HasDatabaseName("UX_CurriculumAdoption_ExplicitLevel")
                        .HasFilter("\"CurriculumLevelKey\" IS NOT NULL");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("SchoolId", "AcademicYearId", "AcademicProgramId", "CurriculumLevelKey", "SubjectId", "FrameworkVersionId"), false);
                    ...
                    b.ToTable("SchoolCurriculumAdoptions", null, t =>
                        {
                            t.HasCheckConstraint("CK_CurriculumAdoption_LogicalLevel", "\"CurriculumLogicalLevel\" IS NULL OR (\"CurriculumLogicalLevel\" BETWEEN 1 AND 13)");
                        });
                });
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.StudentItemExposure", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.LearningEvidence", b =>
                {
                    ...
                    b.HasOne("Edulytics.Core.Entities.PracticeAttempt", null)
                        .WithMany()
                        .HasForeignKey("SchoolId", "PracticeAttemptId")
                        .HasPrincipalKey("SchoolId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Edulytics.Core.Entities.PracticeResponse", b =>
                {
                    b.HasOne("Edulytics.Core.Entities.PracticeAttemptItem", null)
                        .WithMany()
                        .HasForeignKey("SchoolId", "PracticeAttemptItemId")
                        .HasPrincipalKey("SchoolId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
